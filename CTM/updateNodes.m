...
% For parameter estimation using a triangular model, need to express rhoj in terms
% of qmax, vmax, and wf before any updating of nodes occurs
...
for i=1:numLinks
    ...
    % Get neceesary link params
    vmax=clink.vmax;
    qmax=clink.qmax;
    wf=clink.wf;
    
    % Compute rhoj based on triangular model
